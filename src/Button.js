...
const StyledButton = styled.button`
    ...
    overflow: hidden;
    padding: ${(props) =>
      props.size === SIZES.SMALL ? '.5rem 1rem' : '1rem 2rem'};
    position: relative;
    text-align: center;
    ...
    font-size: ${(props) =>
      props.size === SIZES.SMALL ? typography.size.s1 : typography.size.m1}px;
    ...
    &:focus {
        box-shadow: ${rgba(color.primary, 0.4)} 1px 9px 2px;
    }
    ...
    ${text}{
        ...
        transition: transform .7s ${easing.rubber};
        opacity: 1;
    }
    ...
    svg {
        height: ${(props) => (props.size === SIZES.SMALL ? '14' : '16')}
    }
